        ...
        <HeaderStyle>
            <nav>
                ...
                <div onClick={() => changeModalHeader()} className="box-info-user">
                    <img src={infoUser?.profile_picture ? `http://localhost:8080/files/${infoUser?.profile_picture}` : noPhoto} alt="profile image" className={infoUser?.profile_picture !== null ? "contactImage" : "noImage"} />
                    <div>
                        <p>{infoUser?.name}</p>
